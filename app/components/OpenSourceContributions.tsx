      ...
      <div className="grid gap-3">
        {contributions.map((contribution, index) => (
          ...
          >
            ...
            >
              <h3 className="text-lg font-medium text-foreground group-hover:text-accent-foreground">
                {contribution.title}
              </h3>
              <p className="text-muted-foreground/80">{contribution.description}</p>
              <div className="flex items-center text-sm text-muted-foreground">
                <span className="flex items-center">
                  <svg viewBox="0 0 1024 1024" className="w-4 h-4 mr-1.5">
                    <path
                      fill="currentColor"
                ...
                <span className="text-success">已合并</span>
              </div>
            </a>
          </div>
        ))}
